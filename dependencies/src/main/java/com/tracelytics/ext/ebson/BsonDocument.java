...
import com.tracelytics.ext.javax.annotation.CheckForNull;
import com.tracelytics.ext.javax.annotation.Nullable;
...
public interface BsonDocument extends Map<String, Object> {
  ...
  public interface Builder {
    ...
    /**
     * A patched method to allow same key with multiple values (MULTIVAL), this should
