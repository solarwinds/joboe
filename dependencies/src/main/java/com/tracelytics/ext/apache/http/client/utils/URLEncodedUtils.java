...
package com.tracelytics.ext.apache.http.client.utils;
...
public class URLEncodedUtils {
     ...
     *            Encoding to use when decoding the parameters.
     *
     * @deprecated (4.4) use {@link #parse(com.tracelytics.ext.apache.http.util.CharArrayBuffer, java.nio.charset.Charset, char...)}
     */
    @Deprecated
    public static void parse(
            final List <NameValuePair> parameters,
