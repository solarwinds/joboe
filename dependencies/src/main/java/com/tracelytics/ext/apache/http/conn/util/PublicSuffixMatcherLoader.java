 ...
 *
 */
package com.tracelytics.ext.apache.http.conn.util;
...
/**
 * {@link com.tracelytics.ext.apache.http.conn.util.PublicSuffixMatcher} loader.
 *
 * @since 4.4
 */
@ThreadSafe
                ...
                if (DEFAULT_INSTANCE == null){
                    ...
                    if (url != null) {
                        try {
                            ...
                            // Should never happen
                            final Logger log = Logger.getLogger(PublicSuffixMatcherLoader.class.getName());
