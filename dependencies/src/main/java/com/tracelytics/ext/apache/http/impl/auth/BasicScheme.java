...
import com.tracelytics.ext.apache.http.auth.ChallengeState;
...
import com.tracelytics.ext.apache.http.util.EncodingUtils;
...
public class BasicScheme extends RFC2617Scheme {
     ...
     * @throws com.tracelytics.ext.apache.http.auth.InvalidCredentialsException if authentication
    ...
    public Header authenticate(
        ...
        final byte[] base64password = Base64.encodeBytesToBytes(EncodingUtils.getBytes(tmp.toString(), getCredentialsCharset(request)));
    ...
    public static Header authenticate(
        ...
        final byte[] base64password = Base64.encodeBytesToBytes(EncodingUtils.getBytes(tmp.toString(), charset));
