 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link com.tracelytics.ext.apache.http.conn.SchemePortResolver} for default port
 * resolution and {@link com.tracelytics.ext.apache.http.config.Registry} for socket factory lookups.
 */
@Immutable
@Deprecated
