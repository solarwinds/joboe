...
final class NTLMEngineImpl implements NTLMEngine {
     ...
     * @return The response.
     * @throws com.tracelytics.ext.apache.http.HttpException
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(final String messageBody, final int expectedType) throws NTLMEngineException {
            try {
                messageContents = Base64.decode(messageBody.getBytes(DEFAULT_CHARSET));
            } catch (IOException e) {
                throw new NTLMEngineException(e.getMessage(), e);
            }
        ...
        String getResponse() {
            ...
            return EncodingUtils.getAsciiString(Base64.encodeBytesToBytes(resp));
        }
