...
import com.tracelytics.ext.apache.http.client.AuthCache;
...
public class HttpClientContext extends HttpCoreContext {
    ...
    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.conn.routing.RouteInfo}
    ...
    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.config.Lookup} object that represents
     * the actual {@link CookieSpecProvider} registry.
     */
    public static final String COOKIESPEC_REGISTRY   = "http.cookiespec-registry";

    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.cookie.CookieSpec}
     * object that represents the actual cookie specification.
     */
    public static final String COOKIE_SPEC           = "http.cookie-spec";

    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.cookie.CookieOrigin}
     * object that represents the actual details of the origin server.
     */
    public static final String COOKIE_ORIGIN         = "http.cookie-origin";

    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.client.CookieStore}
     * object that represents the actual cookie store.
     */
    public static final String COOKIE_STORE          = "http.cookie-store";

    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.client.CredentialsProvider}
     * object that represents the actual credentials provider.
     */
    public static final String CREDS_PROVIDER        = "http.auth.credentials-provider";

    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.client.AuthCache} object
     * that represents the auth scheme cache.
     */
    public static final String AUTH_CACHE            = "http.auth.auth-cache";

    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.auth.AuthState}
    ...
    /**
     * Attribute name of a {@link com.tracelytics.ext.apache.http.client.config.RequestConfig} object that
