...
import com.tracelytics.ext.apache.http.conn.ConnectTimeoutException;
...
import com.tracelytics.ext.apache.http.conn.HttpHostConnectException;
...
import com.tracelytics.ext.apache.http.conn.UnsupportedSchemeException;
    ...
    public void connect(
        ...
        for (int i = 0; i < addresses.length; i++) {
            ...
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Connecting to " + remoteAddress);
            }
            try {
                ...
                conn.bind(sock);
                if (this.log.isLoggable(Level.FINE)) {
                    this.log.log(Level.FINE, "Connection established " + conn);
                }
                return;
            ...
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Connect to " + remoteAddress + " timed out. " +
