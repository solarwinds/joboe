...
public class VersionInfo {
     ...
     *                  for example "com.tracelytics.ext.apache.http".
    ...
    public static VersionInfo loadVersionInfo(final String pckg,
        ...
        try {
            // com.tracelytics.ext.apache.http      becomes
     ...
     * @param pkg
     *            the package for which to load version information, for example "com.tracelytics.ext.apache.http". The package name
