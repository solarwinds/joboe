...
import com.tracelytics.ext.apache.http.util.LangUtils;
...
public class BasicHttpClientConnectionManager implements HttpClientConnectionManager, Closeable {
        ...
        if (this.conn != null) {
            ...
            try {
                ...
                if (this.log.isLoggable(Level.FINE)) {
                    this.log.log(Level.FINE, "I/O exception closing connection", iox);
                }
            }
            this.conn = null;
        }
    ...
    private void shutdownConnection() {
        if (this.conn != null) {
            this.log.log(Level.FINE, "Shutting down connection");
            try {
                this.conn.shutdown();
            } catch (final IOException iox) {
                if (this.log.isLoggable(Level.FINE)) {
                    this.log.log(Level.FINE, "I/O exception shutting down connection", iox);
                }
            }
            this.conn = null;
        }
    ...
    private void checkExpiry() {
        if (this.conn != null && System.currentTimeMillis() >= this.expiry) {
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Connection expired @ " + new Date(this.expiry));
            }
            closeConnection();
        }
    }
    ...
    synchronized HttpClientConnection getConnection(final HttpRoute route, final Object state) {
        ...
        if (this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Get connection for route " + route);
        }
    ...
    public synchronized void releaseConnection(
        ...
        if (this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Releasing connection " + conn);
        }
