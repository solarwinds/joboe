...
import com.tracelytics.ext.apache.http.config.RegistryBuilder;
import com.tracelytics.ext.apache.http.config.SocketConfig;
import com.tracelytics.ext.apache.http.impl.DefaultConnectionReuseStrategy;
import com.tracelytics.ext.apache.http.impl.NoConnectionReuseStrategy;
import com.tracelytics.ext.apache.http.protocol.HttpProcessor;
import com.tracelytics.ext.apache.http.protocol.HttpProcessorBuilder;
...
import com.tracelytics.ext.apache.http.protocol.RequestContent;
...
import com.tracelytics.ext.apache.http.ssl.SSLContexts;
import com.tracelytics.ext.apache.http.util.TextUtils;
import com.tracelytics.ext.apache.http.util.VersionInfo;

import com.tracelytics.ext.apache.http.auth.AuthSchemeProvider;
import com.tracelytics.ext.apache.http.client.AuthenticationStrategy;
import com.tracelytics.ext.apache.http.client.BackoffManager;
...
import com.tracelytics.ext.apache.http.client.CredentialsProvider;
import com.tracelytics.ext.apache.http.client.HttpRequestRetryHandler;
...
import com.tracelytics.ext.apache.http.client.UserTokenHandler;
...
import com.tracelytics.ext.apache.http.client.entity.InputStreamFactory;
import com.tracelytics.ext.apache.http.client.protocol.RequestAcceptEncoding;
import com.tracelytics.ext.apache.http.client.protocol.RequestAddCookies;
import com.tracelytics.ext.apache.http.client.protocol.RequestAuthCache;
import com.tracelytics.ext.apache.http.client.protocol.RequestClientConnControl;
import com.tracelytics.ext.apache.http.client.protocol.RequestDefaultHeaders;
import com.tracelytics.ext.apache.http.client.protocol.RequestExpectContinue;
import com.tracelytics.ext.apache.http.client.protocol.ResponseContentEncoding;
import com.tracelytics.ext.apache.http.client.protocol.ResponseProcessCookies;
import com.tracelytics.ext.apache.http.conn.ConnectionKeepAliveStrategy;
...
import com.tracelytics.ext.apache.http.conn.socket.ConnectionSocketFactory;
import com.tracelytics.ext.apache.http.conn.socket.LayeredConnectionSocketFactory;
import com.tracelytics.ext.apache.http.conn.socket.PlainConnectionSocketFactory;
import com.tracelytics.ext.apache.http.conn.ssl.DefaultHostnameVerifier;
import com.tracelytics.ext.apache.http.conn.ssl.SSLConnectionSocketFactory;
import com.tracelytics.ext.apache.http.conn.ssl.X509HostnameVerifier;
import com.tracelytics.ext.apache.http.conn.util.PublicSuffixMatcher;
...
import com.tracelytics.ext.apache.http.impl.conn.DefaultProxyRoutePlanner;
import com.tracelytics.ext.apache.http.impl.conn.DefaultRoutePlanner;
import com.tracelytics.ext.apache.http.impl.conn.DefaultSchemePortResolver;
import com.tracelytics.ext.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import com.tracelytics.ext.apache.http.impl.conn.SystemDefaultRoutePlanner;
import com.tracelytics.ext.apache.http.impl.cookie.DefaultCookieSpecProvider;
import com.tracelytics.ext.apache.http.impl.cookie.IgnoreSpecProvider;
import com.tracelytics.ext.apache.http.impl.cookie.NetscapeDraftSpecProvider;
import com.tracelytics.ext.apache.http.impl.cookie.RFC6265CookieSpecProvider;
import com.tracelytics.ext.apache.http.impl.execchain.BackoffStrategyExec;
import com.tracelytics.ext.apache.http.impl.execchain.ClientExecChain;
import com.tracelytics.ext.apache.http.impl.execchain.MainClientExec;
import com.tracelytics.ext.apache.http.impl.execchain.ProtocolExec;
import com.tracelytics.ext.apache.http.impl.execchain.RedirectExec;
import com.tracelytics.ext.apache.http.impl.execchain.RetryExec;
import com.tracelytics.ext.apache.http.impl.execchain.ServiceUnavailableRetryExec;
...
public class HttpClientBuilder {
     ...
     *   com.tracelytics.ext.apache.http.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   com.tracelytics.ext.apache.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link com.tracelytics.ext.apache.http.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see com.tracelytics.ext.apache.http.conn.util.PublicSuffixMatcher
     * @see com.tracelytics.ext.apache.http.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   com.tracelytics.ext.apache.http.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * com.tracelytics.ext.apache.http.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   com.tracelytics.ext.apache.http.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link com.tracelytics.ext.apache.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link com.tracelytics.ext.apache.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     */
    ...
    /**
     * Assigns a map of {@link com.tracelytics.ext.apache.http.client.entity.InputStreamFactory}s
     ...
     * @see com.tracelytics.ext.apache.http.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "com.tracelytics.ext.apache.http.client", getClass());
            }
        }
