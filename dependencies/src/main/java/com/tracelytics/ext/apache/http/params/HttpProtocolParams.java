...
package com.tracelytics.ext.apache.http.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use configuration classes provided 'com.tracelytics.ext.apache.http.config'
 *  and 'com.tracelytics.ext.apache.http.client.config'
 */
@Deprecated
