...
import com.tracelytics.ext.apache.http.pool.PoolEntry;
...
class CPoolEntry extends PoolEntry<HttpRoute, ManagedHttpClientConnection> {
    ...
    public boolean isExpired(final long now) {
        ...
        if (expired && this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Connection " + this + " expired @ " + new Date(getExpiry()));
        }
        return expired;
    }
    ...
    public void close() {
        try {
            ...
            this.log.log(Level.FINE, "I/O error closing connection", ex);
        }
    }
