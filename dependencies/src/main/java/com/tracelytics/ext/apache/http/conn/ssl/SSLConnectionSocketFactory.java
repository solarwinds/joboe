...
package com.tracelytics.ext.apache.http.conn.ssl;
 ...
 * {@link com.tracelytics.ext.apache.http.conn.ssl.TrustStrategy}. This interface is primarily intended for allowing self-signed
...
public class SSLConnectionSocketFactory implements LayeredConnectionSocketFactory {
    ...
    public Socket connectSocket(
        ...
        try {
            ...
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Connecting socket to " + remoteAddress + " with timeout " + connectTimeout);
            }
        ...
        if (sock instanceof SSLSocket) {
            ...
            this.log.log(Level.FINE, "Starting handshake");
    ...
    public Socket createLayeredSocket(
        ...
        if (this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Enabled protocols: " + Arrays.asList(sslsock.getEnabledProtocols()));
            this.log.log(Level.FINE, "Enabled cipher suites:" + Arrays.asList(sslsock.getEnabledCipherSuites()));
        }
    ...
    private void verifyHostname(final SSLSocket sslsock, final String hostname) throws IOException {
        try {
            ...
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Secure session established");
                this.log.log(Level.FINE, " negotiated protocol: " + session.getProtocol());
                this.log.log(Level.FINE, " negotiated cipher suite: " + session.getCipherSuite());
                ...
                try {
                    ...
                    this.log.log(Level.FINE, " peer principal: " + peer.toString());
                    ...
                    if (altNames1 != null) {
                        ...
                        this.log.log(Level.FINE, " peer alternative names: " + altNames);
                    }

                    final X500Principal issuer = x509.getIssuerX500Principal();
                    this.log.log(Level.FINE, " issuer principal: " + issuer.toString());
                    ...
                    if (altNames2 != null) {
                        ...
                        this.log.log(Level.FINE, " issuer alternative names: " + altNames);
                    }
