...
abstract class AuthenticationStrategyImpl implements AuthenticationStrategy {
    ...
    public Queue<AuthOption> select(
        ...
        if (registry == null) {
            this.log.log(Level.FINE, "Auth scheme registry not set in the context");
            return options;
        }
        final CredentialsProvider credsProvider = clientContext.getCredentialsProvider();
        if (credsProvider == null) {
            this.log.log(Level.FINE, "Credentials provider not set in the context");
            return options;
        }
        ...
        if (this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Authentication schemes in the order of preference: " + authPrefs);
        }
            ...
            if (challenge != null) {
                ...
                if (authSchemeProvider == null) {
                    if (this.log.isLoggable(Level.WARNING)) {
                        this.log.log(Level.WARNING, "Authentication scheme " + id + " not supported");
                        // Try again
                    }
                    continue;
                }
                ...
                if (this.log.isLoggable(Level.FINE)) {
                    this.log.log(Level.FINE, "Challenge for " + id + " authentication scheme not available");
                    // Try again
                }
            }
        }
    ...
    public void authSucceeded(
        ...
        if (isCachable(authScheme)) {
            ...
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Caching '" + authScheme.getSchemeName() +
    ...
    public void authFailed(
        ...
        if (authCache != null) {
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Clearing cached auth scheme for " + authhost);
            }
