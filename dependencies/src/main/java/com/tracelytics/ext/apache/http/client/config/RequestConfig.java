...
package com.tracelytics.ext.apache.http.client.config;
...
public class RequestConfig implements Cloneable {
     ...
     *   com.tracelytics.ext.apache.http.impl.conn.PoolingHttpClientConnectionManager#getValidateAfterInactivity()}
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * @deprecated (4.4) Use {@link
         *   com.tracelytics.ext.apache.http.impl.conn.PoolingHttpClientConnectionManager#setValidateAfterInactivity(int)}
         */
        @Deprecated
