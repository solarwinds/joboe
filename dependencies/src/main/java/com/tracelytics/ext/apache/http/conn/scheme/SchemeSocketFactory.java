...
package com.tracelytics.ext.apache.http.conn.scheme;
 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link com.tracelytics.ext.apache.http.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory {
     ...
     * <p>
     * Please note that {@link com.tracelytics.ext.apache.http.conn.HttpInetSocketAddress} class should
     * be used in order to pass the target remote address along with the original
     * {@link com.tracelytics.ext.apache.http.HttpHost} value used to resolve the address. The use of
     * {@link com.tracelytics.ext.apache.http.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see com.tracelytics.ext.apache.http.conn.HttpInetSocketAddress
     */
