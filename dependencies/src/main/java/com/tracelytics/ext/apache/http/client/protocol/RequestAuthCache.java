...
public class RequestAuthCache implements HttpRequestInterceptor {
    ...
    public void process(final HttpRequest request, final HttpContext context)
        ...
        if (authCache == null) {
            this.log.log(Level.FINE, "Auth cache not set in the context");
            return;
        }
        ...
        if (route == null) {
            this.log.log(Level.FINE, "Route info not set in the context");
            return;
        }
    ...
    private void doPreemptiveAuth(
        ...
        if (this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Re-using cached '" + schemeName + "' auth scheme for " + host);
        }
        ...
        if (creds != null) {
            ...
            this.log.log(Level.FINE, "No credentials for preemptive authentication");
        }
    }
