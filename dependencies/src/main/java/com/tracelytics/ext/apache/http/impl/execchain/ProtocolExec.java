...
import com.tracelytics.ext.apache.http.auth.UsernamePasswordCredentials;
...
import com.tracelytics.ext.apache.http.impl.client.BasicCredentialsProvider;
...
public class ProtocolExec implements ClientExecChain {
    ...
    public CloseableHttpResponse execute(
        ...
        if (original instanceof HttpUriRequest) {
            ...
            try {
                ...
                if (this.log.isLoggable(Level.FINE)) {
                    this.log.log(Level.FINE, "Unable to parse '" + uriString + "' as a valid URI; " +
        ...
        if (virtualHost != null && virtualHost.getPort() == -1) {
            ...
            if (this.log.isLoggable(Level.FINE)) {
                this.log.log(Level.FINE, "Using virtual host" + virtualHost);
            }
        }
