...
import com.tracelytics.ext.apache.http.client.CircularRedirectException;
...
import com.tracelytics.ext.apache.http.client.methods.HttpGet;
import com.tracelytics.ext.apache.http.client.methods.HttpHead;
import com.tracelytics.ext.apache.http.client.methods.HttpUriRequest;
import com.tracelytics.ext.apache.http.client.methods.RequestBuilder;
...
public class DefaultRedirectStrategy implements RedirectStrategy {
    ...
    /**
     * @deprecated (4.3) use {@link com.tracelytics.ext.apache.http.client.protocol.HttpClientContext#REDIRECT_LOCATIONS}.
     */
    @Deprecated
    ...
    public URI getLocationURI(
        ...
        if (this.log.isLoggable(Level.FINE)) {
            this.log.log(Level.FINE, "Redirect requested to location '" + location + "'");
        }
