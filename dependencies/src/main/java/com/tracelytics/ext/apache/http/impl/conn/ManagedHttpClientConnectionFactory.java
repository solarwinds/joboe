...
import com.tracelytics.ext.apache.http.impl.io.DefaultHttpRequestWriterFactory;
...
public class ManagedHttpClientConnectionFactory
    ...
    private final Logger log = Logger.getLogger(DefaultManagedHttpClientConnection.class.getName());
    private final Logger headerlog = Logger.getLogger("com.tracelytics.ext.apache.http.headers");
    private final Logger wirelog = Logger.getLogger("com.tracelytics.ext.apache.http.wire");
