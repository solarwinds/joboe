...
//                    if (name.lastIndexOf('$') < thisName.length())
                    ...
                    if (declaringClass == null) { //then use the old javassist logic
                        if (name.lastIndexOf('$') < thisName.length()) {
                            list.add(nestedClass);
                        }
                    } else if (this.getName().startsWith(declaringClass.getName())) { //In order to support Scala, which the naming scheme is different
                        list.add(nestedClass);
                    }
                }
        }
