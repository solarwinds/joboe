...
public class SampleRestServlet extends HttpServlet {
    ...
    private Data testManualSampleClient() throws Exception {
        ...
        request.pathParameter("param", "Default").queryParameter("duration", 1000);
    ...
    private Data testProxySampleClient() {
        ...
        result = client.getResult("dummy", 1000).result;
        System.out.println(result.path);
        
        result = client.putResult("dummy", 1000).result;
        System.out.println(result.path);
        
        result = client.deleteResult("dummy", 1000).result;
        System.out.println(result.path);
        
        result = client.postResult("dummy", 1000).result;
        System.out.println(result.path);
