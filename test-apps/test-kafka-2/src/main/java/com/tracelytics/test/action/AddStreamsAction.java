...
public class AddStreamsAction extends AbstractMqAction {
    @Override
    public String execute() throws Exception {
        ...
        WebsocketWriter.write("consume", "Created stream for topic [" + topic + "]");
    ...
    private static class SleepProcessor implements Processor<String, String> {

        private final String sessionId;
        private final String topic;
        private ProcessorContext processorContext;

        public SleepProcessor(String sessionId, String topic) {
        ...
        public void process(String key, String value) {
            processStreamMessage(topic, key, value, sessionId);
        }
...
//    @Trace(dispatcher = true)
    private static KeyValue<? extends String, ? extends String> processStreamMessage(String topic, String key, String value, String sessionId)  {
        try {
            ...
            WebsocketWriter.write(sessionId, "consume", "Processing stream for topic " + topic + " key " + key + " message " + value);
