...
public class TestAll extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        XMemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses(getHost() + ":11211"));
        if (isBinary) {
...
//        transcoders.add(sampleTranscoder);
        ...
        client.decr("numTest", 2, 0, TIME_OUT, duration);
        client.decrWithNoReply("numTest", 1);
        
        client.delete(key);
        client.delete(key, (long)TIME_OUT);
        ...
        if (isBinary) {
            ...
            client.getAndTouch(key, duration, TIME_OUT);
        }
        ...
        client.incr("numTest", 2, 0, TIME_OUT, duration);
        ...
        if (isBinary) {
            ...
            client.touch(key, duration, TIME_OUT);
        }
