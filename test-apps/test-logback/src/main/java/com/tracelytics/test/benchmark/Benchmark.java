...
public class Benchmark {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0 ; i < RUN_COUNT ; i ++) {
            Logger noMdcLogger = getLogger("no-mdc", "%msg%n");
            Logger mdcLogger = getLogger("mdc", "%X{ao.traceId}%msg%n");
            ...
            noMdcLogger.detachAndStopAllAppenders();
            ...
            mdcLogger.detachAndStopAllAppenders();
    ...
    private static Logger getLogger(String name, String pattern) {
        Logger logger = (Logger) LoggerFactory.getLogger(name);
        Context context = (Context) LoggerFactory.getILoggerFactory();
        
        logger.detachAndStopAllAppenders();
        FileAppender<ILoggingEvent> fileAppender = new FileAppender<ILoggingEvent>();//new FileAppender(new PatternLayout("%m%n"), "no-mdc", false, true, 8 * 1024);
