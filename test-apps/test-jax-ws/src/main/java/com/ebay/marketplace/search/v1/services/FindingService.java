 ...
 * 
 */
@WebServiceClient(name = "FindingService", targetNamespace = "http://www.ebay.com/marketplace/search/v1/services", wsdlLocation = "classpath:wsdl/FindingService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        if (url == null) {
            e = new WebServiceException("Cannot locate wsdl/FindingService.wsdl");
        }
