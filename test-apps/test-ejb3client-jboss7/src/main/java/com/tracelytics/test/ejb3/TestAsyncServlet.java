...
public class TestAsyncServlet extends HttpServlet {
    ...
    private String callRemote(Integer v)
        ...
        TestEJB3Remote remote = EJBClient.asynchronous((TestEJB3Remote) obj); //not working for JBoss 7, always return non asynchronous proxy
        
        return (String) EJBClient.getFutureResult(remote.testOp(v)).get();
    }
