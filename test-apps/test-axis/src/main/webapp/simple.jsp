...
<form action="sampleSoap.do">
	<input type="submit" value="Test local Sample SOAP"/>
</form>

<form action="sampleSoapAsync.do">
	<input type="submit" value="Test local Sample SOAP (Async)"/>
</form>

<form action="sampleRest.do">
	<input type="submit" value="Test local Sample REST"/>
</form>

<form action="sampleRestAsync.do">
	<input type="submit" value="Test local Sample REST (Async)"/>
</form>
