 ...
 * 
 */
@WebServiceClient(name = "Weather", targetNamespace = "http://ws.cdyne.com/WeatherWS/", wsdlLocation = "file:/home/pluk/git/joboe/test-apps/test-glassfishws-min/src/main/resources/wsdl/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/pluk/git/joboe/test-apps/test-glassfishws-min/src/main/resources/wsdl/weather.wsdl");
