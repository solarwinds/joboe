 ...
 * 
 */
@WebServiceClient(name = "FindingService", targetNamespace = "http://www.ebay.com/marketplace/search/v1/services", wsdlLocation = "file:/home/pluk/git/joboe/test-apps/test-glassfishws-min/src/main/resources/wsdl/FindingService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/pluk/git/joboe/test-apps/test-glassfishws-min/src/main/resources/wsdl/FindingService.wsdl");
