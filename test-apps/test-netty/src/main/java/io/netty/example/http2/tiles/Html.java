...
public final class Html {
    ...
    public static final byte[] HEADER = ("<!DOCTYPE html><html><head lang=\"en\"><title>Netty HTTP/2 Example</title>"
            ...
            + "?latency=1000'>HTTP/1, 1s latency</a>]<br/>" + "[<a href='https://" + url(Http2Server.PORT)
            + "?latency=10000'>HTTP/2, 10s latency</a>] [<a href='http://" + url(HttpServer.PORT)
            + "?latency=10000'>HTTP/1, " + "10s latency</a>]<br/>").getBytes(UTF_8);
