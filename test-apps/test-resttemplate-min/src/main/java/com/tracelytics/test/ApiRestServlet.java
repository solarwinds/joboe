...
public class ApiRestServlet extends HttpServlet {
    ...
    private static class TestMessageConverter implements HttpMessageConverter<Data> {
        ...
        public boolean canRead(Class<? extends Data> clazz, MediaType mediaType) {
            return true;
        }

        public boolean canWrite(Class<? extends Data> clazz, MediaType mediaType) {
            return false;
        }
        ...
        public Data read(Class<Data> clazz, HttpInputMessage inputMessage)
