...
class FileLoggerStream implements LoggerStream, Closeable {
  ...
  public void close(long closeTimeoutInSec) {
    ...
    try {
      ...
      closeIo();
      //                Files.deleteIfExists(logFileLockPath); //Do not attempt to delete file, it's
  ...
  boolean lockAndRollFile() throws IOException {
    ...
    try {
      ...
      if (fileLockAndChannel != null) {
        ...
        // Files.deleteIfExists(logFileLockPath); //do NOT delete the file as locking and deleting
        // do not work well in some OS
      }
    }
  }
