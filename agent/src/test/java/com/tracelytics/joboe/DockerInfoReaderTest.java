...
import com.tracelytics.joboe.AgentHostInfoReader.DockerInfoReader;

import junit.framework.TestCase;

public class DockerInfoReaderTest extends TestCase {
    private static final String TEST_FILE_PREFIX = "src/test/java/com/tracelytics/joboe/docker-cgroup-"; //using a rather static path. Using Class.getResourceAsStream does not work in test (vs main)
