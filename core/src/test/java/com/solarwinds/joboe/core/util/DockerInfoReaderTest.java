...
public class DockerInfoReaderTest {
    private static final String TEST_FILE_PREFIX = "src/test/java/com/solarwinds/joboe/core/util/docker-cgroup-"; //using a rather static path. Using Class.getResourceAsStream does not work in test (vs main)
