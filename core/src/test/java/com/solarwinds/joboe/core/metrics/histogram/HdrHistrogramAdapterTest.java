...
public class HdrHistrogramAdapterTest {
  ...
  public void testEncode() throws Exception {
    HdrHistogramAdapter testHistogram =
        new HdrHistogramAdapter(MAX_VALUE, HistogramFactory.NUMBER_OF_SIGNIFICANT_VALUE_DIGITS);
    ...
    String expectedEncodedString =
        "HISTFAAAAC14nJNpmSzMwMDAywABzFCaEURcm7yEwf4DRGCpMlMskyvTZWam+4xMAKW6B74="; // extracted
    // from encode
    // call of above
    // values from
    // c-lib
    ...
    Histogram readHistogram = Histogram.decodeFromCompressedByteBuffer(buffer, 0);
