...
public abstract class RpcClientTest {
  ...
  public void testConnectLazyServer() throws Exception {
    ...
    // TServer lazyServer = startTestCollector(tryLaterPort, tryLaterHandler); //DO NOT START SERVER
    // YET
  ...
  public void testUnstableServer() throws Exception {
    ...
    try {
      ...
      for (int i = 0; i < 100; i++) {
        ...
        // intermittedly
        // futures.add(client.postEvents(TEST_EVENTS, null)); //post alot of events, and it is
        // supposed to retry if connection is gone intermittedly
