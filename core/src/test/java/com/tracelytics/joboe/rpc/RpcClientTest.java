...
public abstract class RpcClientTest {
    ...
    public void testConnectValidServer() throws Exception {
        ...
        try {
            ...
            assertEquals(com.tracelytics.joboe.rpc.ResultCode.OK, client.postEvents(TEST_EVENTS, null).get().getResultCode());
    ...
    public void testGetSettings() throws Exception  {
        ...
        try {
            ...
            com.tracelytics.joboe.rpc.SettingsResult result = client.getSettings("", null).get();
            ...
            for (int i = 0 ; i < TEST_SETTINGS.size(); i ++) {
                ...
                com.tracelytics.joboe.settings.Settings receivedSetting = result.getSettings().get(i);
    ...
    public void testRedirectLoop() throws Exception {
        ...
        try {
            ...
            assertEquals(com.tracelytics.joboe.rpc.ResultCode.REDIRECT, client.postEvents(TEST_EVENTS, null).get().getResultCode());
        } finally {
            if (client != null) {
                client.close();
            }
