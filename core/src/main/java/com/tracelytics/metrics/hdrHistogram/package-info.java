 ...
 * <pre>
 * <code>
 * {@link com.tracelytics.ext.hdrHistogram.Histogram} histogram = new {@link com.tracelytics.ext.hdrHistogram.Histogram}(3600000000L, 3);
 * .
 * .
 * .
 * // Repeatedly record measured latencies:
 * histogram.{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#recordValue(long) recordValue}(latency);
 * .
 * .
 * .
 * // Report histogram percentiles, expressed in msec units:
 * histogram.{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#outputPercentileDistribution(java.io.PrintStream, Double) outputPercentileDistribution}(histogramLog, 1000.0)};
 * </code>
 * </pre>
 ...
 * The HdrHistogram package includes multiple implementations of the {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram} class:
 * <ul>
 *  <li> {@link com.tracelytics.ext.hdrHistogram.Histogram}, which is the commonly used Histogram form and tracks value counts
 * in <b><code>long</code></b> fields. </li>
 *  <li>{@link com.tracelytics.ext.hdrHistogram.IntCountsHistogram} and {@link com.tracelytics.ext.hdrHistogram.ShortCountsHistogram}, which track value counts
 ...
 * being tracked).</li>
 *  <li>{@link com.tracelytics.ext.hdrHistogram.AtomicHistogram}, {@link com.tracelytics.ext.hdrHistogram.ConcurrentHistogram}
 *  and {@link com.tracelytics.ext.hdrHistogram.SynchronizedHistogram}</li>
 * </ul>
 * <p>
 ...
 * In the interest of keeping value recording cost to a minimum, the commonly used {@link com.tracelytics.ext.hdrHistogram.Histogram}
 * class and it's {@link com.tracelytics.ext.hdrHistogram.IntCountsHistogram} and {@link com.tracelytics.ext.hdrHistogram.ShortCountsHistogram}
 ...
 * synchronize and/or order their access, or use the {@link com.tracelytics.ext.hdrHistogram.ConcurrentHistogram},
 * {@link com.tracelytics.ext.hdrHistogram.AtomicHistogram}, or {@link com.tracelytics.ext.hdrHistogram.SynchronizedHistogram} variants.
 * <p>
 ...
 * reporting operations are needed, consider using the {@link com.tracelytics.ext.hdrHistogram.Recorder} and
 * {@link com.tracelytics.ext.hdrHistogram.SingleWriterRecorder} variants that were specifically designed for that purpose.
 ...
 * non-synchronized histograms or {@link com.tracelytics.ext.hdrHistogram.SingleWriterRecorder}s, and using a summary/reporting
 ...
 * each possible value level. The iteration mechanisms all provide {@link com.tracelytics.ext.hdrHistogram.HistogramIterationValue}
 * data points along the histogram's iterated data set, and are available via the following methods:
 * <ul>
 *     <li>{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#percentiles percentiles} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.tracelytics.ext.hdrHistogram.HistogramIterationValue}{@literal >} through the
 *     histogram using a {@link com.tracelytics.ext.hdrHistogram.PercentileIterator} </li>
 *     <li>{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#linearBucketValues linearBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.tracelytics.ext.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.tracelytics.ext.hdrHistogram.LinearIterator} </li>
 *     <li>{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#logarithmicBucketValues logarithmicBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.tracelytics.ext.hdrHistogram.HistogramIterationValue}{@literal >}
 *     through the histogram using a {@link com.tracelytics.ext.hdrHistogram.LogarithmicIterator} </li>
 *     <li>{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#recordedValues recordedValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.tracelytics.ext.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.tracelytics.ext.hdrHistogram.RecordedValuesIterator} </li>
 *     <li>{@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#allValues allValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.tracelytics.ext.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.tracelytics.ext.hdrHistogram.AllValuesIterator} </li>
 * </ul>
 * <p>
 ...
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#recordValue(long) recordValue()} method.
 * <p>
 * Histogram variants also provide an auto-correcting
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#recordValue(long) recordValue()}
 * and with
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * methods
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#copyCorrectedForCoordinatedOmission(long) copyCorrectedForCoordinatedOmission()}
 * and
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#addWhileCorrectingForCoordinatedOmission(AbstractHistogram, long) addWhileCorrectingForCoordinatedOmission()}.
 ...
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram} and their related supporting classes). HdrHistogram supports floating
 * point value recording and reporting with a similar set of classes, including the
 * {@link com.tracelytics.ext.hdrHistogram.DoubleHistogram}, {@link com.tracelytics.ext.hdrHistogram.ConcurrentDoubleHistogram} and
 * {@link com.tracelytics.ext.hdrHistogram.SynchronizedDoubleHistogram} histogram classes. Support for floating point value
 * iteration is provided with {@link com.tracelytics.ext.hdrHistogram.DoubleHistogramIterationValue} and related iterator classes (
 * {@link com.tracelytics.ext.hdrHistogram.DoubleLinearIterator}, {@link com.tracelytics.ext.hdrHistogram.DoubleLogarithmicIterator},
 * {@link com.tracelytics.ext.hdrHistogram.DoublePercentileIterator}, {@link com.tracelytics.ext.hdrHistogram.DoubleRecordedValuesIterator},
 * {@link com.tracelytics.ext.hdrHistogram.DoubleAllValuesIterator}). Support for interval recording is provided with
 * {@link com.tracelytics.ext.hdrHistogram.DoubleRecorder} and
 * {@link com.tracelytics.ext.hdrHistogram.SingleWriterDoubleRecorder}.
 ...
 * com.tracelytics.ext.hdrHistogram.DoubleHistogram} (and variants) is not specified upfront. Only the dynamic range of values
 * that the histogram can cover is (optionally) specified. E.g. When a {@link com.tracelytics.ext.hdrHistogram.DoubleHistogram}
 ...
 * {@link com.tracelytics.ext.hdrHistogram.AbstractHistogram#getEstimatedFootprintInBytes() getEstimatedFootprintInBytes()} method.
 */

package com.tracelytics.metrics.hdrHistogram;
