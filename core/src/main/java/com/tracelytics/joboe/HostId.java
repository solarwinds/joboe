...
public class HostId {
    ...
    public HostId(String hostname, int pid, List<String> macAddresses, String ec2InstanceId, String ec2AvailabilityZone, String dockerContainerId, String herokuDynoId, String azureInstanceId, HostType hostType) {
        super();
