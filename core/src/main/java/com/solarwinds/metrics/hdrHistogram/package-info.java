 ...
 * <pre>
 * <code>
 * {@link com.solarwinds.metrics.hdrHistogram.Histogram} histogram = new {@link com.solarwinds.metrics.hdrHistogram.Histogram}(3600000000L, 3);
 * .
 * .
 * .
 * // Repeatedly record measured latencies:
 * histogram.{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#recordValue(long) recordValue}(latency);
 * .
 * .
 * .
 * // Report histogram percentiles, expressed in msec units:
 * histogram.{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#outputPercentileDistribution(java.io.PrintStream, Double) outputPercentileDistribution}(histogramLog, 1000.0)};
 * </code>
 * </pre>
 ...
 * The HdrHistogram package includes multiple implementations of the {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram} class:
 * <ul>
 *  <li> {@link com.solarwinds.metrics.hdrHistogram.Histogram}, which is the commonly used Histogram form and tracks value counts
 * in <b><code>long</code></b> fields. </li>
 *  <li>{@link com.solarwinds.metrics.hdrHistogram.IntCountsHistogram} and {@link com.solarwinds.metrics.hdrHistogram.ShortCountsHistogram}, which track value counts
 ...
 * being tracked).</li>
 *  <li>{@link com.solarwinds.metrics.hdrHistogram.AtomicHistogram}, {@link com.solarwinds.metrics.hdrHistogram.ConcurrentHistogram}
 *  and {@link com.solarwinds.metrics.hdrHistogram.SynchronizedHistogram}</li>
 * </ul>
 * <p>
 ...
 * In the interest of keeping value recording cost to a minimum, the commonly used {@link com.solarwinds.metrics.hdrHistogram.Histogram}
 * class and it's {@link com.solarwinds.metrics.hdrHistogram.IntCountsHistogram} and {@link com.solarwinds.metrics.hdrHistogram.ShortCountsHistogram}
 ...
 * synchronize and/or order their access, or use the {@link com.solarwinds.metrics.hdrHistogram.ConcurrentHistogram},
 * {@link com.solarwinds.metrics.hdrHistogram.AtomicHistogram}, or {@link com.solarwinds.metrics.hdrHistogram.SynchronizedHistogram} variants.
 * <p>
 ...
 * reporting operations are needed, consider using the {@link com.solarwinds.metrics.hdrHistogram.Recorder} and
 * {@link com.solarwinds.metrics.hdrHistogram.SingleWriterRecorder} variants that were specifically designed for that purpose.
 ...
 * non-synchronized histograms or {@link com.solarwinds.metrics.hdrHistogram.SingleWriterRecorder}s, and using a summary/reporting
 ...
 * each possible value level. The iteration mechanisms all provide {@link com.solarwinds.metrics.hdrHistogram.HistogramIterationValue}
 * data points along the histogram's iterated data set, and are available via the following methods:
 * <ul>
 *     <li>{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#percentiles percentiles} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through the
 *     histogram using a {@link com.solarwinds.metrics.hdrHistogram.PercentileIterator} </li>
 *     <li>{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#linearBucketValues linearBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.solarwinds.metrics.hdrHistogram.LinearIterator} </li>
 *     <li>{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#logarithmicBucketValues logarithmicBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.metrics.hdrHistogram.HistogramIterationValue}{@literal >}
 *     through the histogram using a {@link com.solarwinds.metrics.hdrHistogram.LogarithmicIterator} </li>
 *     <li>{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#recordedValues recordedValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.solarwinds.metrics.hdrHistogram.RecordedValuesIterator} </li>
 *     <li>{@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#allValues allValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.solarwinds.metrics.hdrHistogram.AllValuesIterator} </li>
 * </ul>
 * <p>
 ...
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#recordValue(long) recordValue()} method.
 * <p>
 * Histogram variants also provide an auto-correcting
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#recordValue(long) recordValue()}
 * and with
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * methods
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#copyCorrectedForCoordinatedOmission(long) copyCorrectedForCoordinatedOmission()}
 * and
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#addWhileCorrectingForCoordinatedOmission(AbstractHistogram, long) addWhileCorrectingForCoordinatedOmission()}.
 ...
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram} and their related supporting classes). HdrHistogram supports floating
 * point value recording and reporting with a similar set of classes, including the
 * {@link com.solarwinds.metrics.hdrHistogram.DoubleHistogram}, {@link com.solarwinds.metrics.hdrHistogram.ConcurrentDoubleHistogram} and
 * {@link com.solarwinds.metrics.hdrHistogram.SynchronizedDoubleHistogram} histogram classes. Support for floating point value
 * iteration is provided with {@link com.solarwinds.metrics.hdrHistogram.DoubleHistogramIterationValue} and related iterator classes (
 * {@link com.solarwinds.metrics.hdrHistogram.DoubleLinearIterator}, {@link com.solarwinds.metrics.hdrHistogram.DoubleLogarithmicIterator},
 * {@link com.solarwinds.metrics.hdrHistogram.DoublePercentileIterator}, {@link com.solarwinds.metrics.hdrHistogram.DoubleRecordedValuesIterator},
 * {@link com.solarwinds.metrics.hdrHistogram.DoubleAllValuesIterator}). Support for interval recording is provided with
 * {@link com.solarwinds.metrics.hdrHistogram.DoubleRecorder} and
 * {@link com.solarwinds.metrics.hdrHistogram.SingleWriterDoubleRecorder}.
 ...
 * com.solarwinds.metrics.hdrHistogram.DoubleHistogram} (and variants) is not specified upfront. Only the dynamic range of values
 * that the histogram can cover is (optionally) specified. E.g. When a {@link com.solarwinds.metrics.hdrHistogram.DoubleHistogram}
 ...
 * {@link com.solarwinds.metrics.hdrHistogram.AbstractHistogram#getEstimatedFootprintInBytes() getEstimatedFootprintInBytes()} method.
 */
