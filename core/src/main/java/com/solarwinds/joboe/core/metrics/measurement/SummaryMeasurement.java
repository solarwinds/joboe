...
/**
 * A {@link Measurement} that holds the summary of a series of values provided by {@link
 * recordValue} calls.
 *
 * <p>Currently this only keep track of count and sum of the value series.
 *
 * @author pluk
 */
@Getter
public abstract class SummaryMeasurement<T extends Number> extends Measurement<T> {
  ...
  // might implement full summary at https://www.librato.com/docs/api/#create-a-measurement in
  // future
