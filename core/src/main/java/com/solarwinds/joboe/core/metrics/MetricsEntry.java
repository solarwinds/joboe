...
/**
 * Represents a metrics entry which contains a {@code MetricsKey} and a value with type specified by
 * the child class.
 *
 * <p>Metrics collected by various {@code AbstractMetricsEntryCollector} are all converted into this
 * metric entry format for more generic handling in the {@code MetricsReporter}
 *
 * @author pluk
