...
/**
 * Records floating point values, and provides stable interval {@link DoubleHistogram} samples from
 ...
 * ongoing.
 *
 * <p>{@link SingleWriterDoubleRecorder} expects only a single thread (the "single writer") to call
 * {@link SingleWriterDoubleRecorder#recordValue} or {@link
 * SingleWriterDoubleRecorder#recordValueWithExpectedInterval} at any point in time. It DOES NOT
 * support concurrent recording calls.
 */
public class SingleWriterDoubleRecorder {
  ...
  /**
   * Construct a {@link SingleWriterDoubleRecorder} dynamic range of values to cover and a number of
   ...
   *
   * <p>See related notes {@link DoubleHistogram#recordValueWithExpectedInterval(double, double)}
   ...
   *
   * <p>Calling {@link SingleWriterDoubleRecorder#getIntervalHistogram()} will reset the value
   * counts, and start accumulating value counts for the next interval.
   *
   ...
   *
   * <p>{@link SingleWriterDoubleRecorder#getIntervalHistogram(DoubleHistogram histogramToRecycle)
   ...
   * SingleWriterDoubleRecorder#getIntervalHistogram()} and {@link
   * SingleWriterDoubleRecorder#getIntervalHistogramInto getIntervalHistogramInto()}. The provided
   * {@code histogramToRecycle} must be either be null or an interval histogram returned by a
   * previous call to {@link SingleWriterDoubleRecorder#getIntervalHistogram(DoubleHistogram
   * histogramToRecycle) getIntervalHistogram(histogramToRecycle)} or {@link
   ...
   * undefined.
   *
   * <p>Calling {@link SingleWriterDoubleRecorder#getIntervalHistogram(DoubleHistogram
   * histogramToRecycle) getIntervalHistogram(histogramToRecycle)} will reset the value counts, and
   ...
   *
   * <p>Calling {@link SingleWriterDoubleRecorder#getIntervalHistogramInto}() will reset the value
   * counts, and start accumulating value counts for the next interval.
   *
  ...
  private static class InternalDoubleHistogram extends DoubleHistogram {
    ...
    private InternalDoubleHistogram(
        long id, long highestToLowestValueRatio, int numberOfSignificantValueDigits) {
