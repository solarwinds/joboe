...
/**
 * Used for iterating through histogram values using the finest granularity steps supported by the
 * underlying representation. The iteration steps through all possible unit value levels, regardless
 * of whether or not there were recorded values for that value level, and terminates when all
