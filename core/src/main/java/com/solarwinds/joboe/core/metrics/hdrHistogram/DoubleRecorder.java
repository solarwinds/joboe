...
/**
 * Records floating point (double) values, and provides stable interval {@link DoubleHistogram}
 * samples from live recorded data without interrupting or stalling active recording of values. Each
 * interval histogram provided contains all value counts accumulated since the previous interval
 * histogram was taken.
 *
 * <p>This pattern is commonly used in logging interval histogram information while recording is
 * ongoing.
 *
 * <p>{@link DoubleRecorder} supports concurrent {@link DoubleRecorder#recordValue} or {@link
 * DoubleRecorder#recordValueWithExpectedInterval} calls. Recording calls are wait-free on
 * architectures that support atomic increment operations, and are lock-free on architectures that
 * do not.
 */
public class DoubleRecorder {
   ...
   *
   * <p>Calling {@link DoubleRecorder#getIntervalHistogram()} will reset the value counts, and start
   ...
   *
   * <p>{@link DoubleRecorder#getIntervalHistogram(DoubleHistogram histogramToRecycle)
   ...
   * DoubleRecorder#getIntervalHistogram()} and {@link DoubleRecorder#getIntervalHistogramInto
   * getIntervalHistogramInto()}. The provided {@code histogramToRecycle} must be either be null or
   * an interval histogram returned by a previous call to {@link
   * DoubleRecorder#getIntervalHistogram(DoubleHistogram histogramToRecycle)
   * getIntervalHistogram(histogramToRecycle)} or {@link DoubleRecorder#getIntervalHistogram()}.
   *
   ...
   * undefined.
   *
   * <p>Calling {@link DoubleRecorder#getIntervalHistogram(DoubleHistogram histogramToRecycle)
   ...
   *
   * <p>Calling {@link DoubleRecorder#getIntervalHistogramInto}() will reset the value counts, and
  ...
  private static class InternalConcurrentDoubleHistogram extends ConcurrentDoubleHistogram {
    ...
    private InternalConcurrentDoubleHistogram(
