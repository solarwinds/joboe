...
/**
 * Used for iterating through {@link DoubleHistogram} values using the finest granularity steps
...
public class DoubleAllValuesIterator implements Iterator<DoubleHistogramIterationValue> {
  ...
  public DoubleAllValuesIterator(final DoubleHistogram histogram) {
    ...
    iterationValue =
        new DoubleHistogramIterationValue(integerAllValuesIterator.currentIterationValue);
  }
