 ...
 * The HdrHistogram package includes multiple implementations of the {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram} class:
 * <ul>
 *  <li> {@link com.solarwinds.joboe.core.metrics.hdrHistogram.Histogram}, which is the commonly used Histogram form and tracks value counts
 * in <b><code>long</code></b> fields. </li>
 *  <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.IntCountsHistogram} and {@link com.solarwinds.joboe.core.metrics.hdrHistogram.ShortCountsHistogram}, which track value counts
 ...
 * being tracked).</li>
 *  <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.AtomicHistogram}, {@link com.solarwinds.joboe.core.metrics.hdrHistogram.ConcurrentHistogram}
 *  and {@link com.solarwinds.joboe.core.metrics.hdrHistogram.SynchronizedHistogram}</li>
 * </ul>
 * <p>
 ...
 * In the interest of keeping value recording cost to a minimum, the commonly used {@link com.solarwinds.joboe.core.metrics.hdrHistogram.Histogram}
 * class and it's {@link com.solarwinds.joboe.core.metrics.hdrHistogram.IntCountsHistogram} and {@link com.solarwinds.joboe.core.metrics.hdrHistogram.ShortCountsHistogram}
 ...
 * synchronize and/or order their access, or use the {@link com.solarwinds.joboe.core.metrics.hdrHistogram.ConcurrentHistogram},
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AtomicHistogram}, or {@link com.solarwinds.joboe.core.metrics.hdrHistogram.SynchronizedHistogram} variants.
 * <p>
 ...
 * reporting operations are needed, consider using the {@link com.solarwinds.joboe.core.metrics.hdrHistogram.Recorder} and
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.SingleWriterRecorder} variants that were specifically designed for that purpose.
 ...
 * non-synchronized histograms or {@link com.solarwinds.joboe.core.metrics.hdrHistogram.SingleWriterRecorder}s, and using a summary/reporting
 ...
 * each possible value level. The iteration mechanisms all provide {@link com.solarwinds.joboe.core.metrics.hdrHistogram.HistogramIterationValue}
 * data points along the histogram's iterated data set, and are available via the following methods:
 * <ul>
 *     <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#percentiles percentiles} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.joboe.core.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through the
 *     histogram using a {@link com.solarwinds.joboe.core.metrics.hdrHistogram.PercentileIterator} </li>
 *     <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#linearBucketValues linearBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.joboe.core.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.solarwinds.joboe.core.metrics.hdrHistogram.LinearIterator} </li>
 *     <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#logarithmicBucketValues logarithmicBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.joboe.core.metrics.hdrHistogram.HistogramIterationValue}{@literal >}
 *     through the histogram using a {@link com.solarwinds.joboe.core.metrics.hdrHistogram.LogarithmicIterator} </li>
 *     <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#recordedValues recordedValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.joboe.core.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.solarwinds.joboe.core.metrics.hdrHistogram.RecordedValuesIterator} </li>
 *     <li>{@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#allValues allValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link com.solarwinds.joboe.core.metrics.hdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AllValuesIterator} </li>
 * </ul>
 * <p>
 ...
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#recordValue(long) recordValue()} method.
 * <p>
 * Histogram variants also provide an auto-correcting
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#recordValue(long) recordValue()}
 * and with
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * methods
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#copyCorrectedForCoordinatedOmission(long) copyCorrectedForCoordinatedOmission()}
 * and
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#addWhileCorrectingForCoordinatedOmission(AbstractHistogram, long) addWhileCorrectingForCoordinatedOmission()}.
 ...
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram} and their related supporting classes). HdrHistogram supports floating
 * point value recording and reporting with a similar set of classes, including the
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleHistogram}, {@link com.solarwinds.joboe.core.metrics.hdrHistogram.ConcurrentDoubleHistogram} and
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.SynchronizedDoubleHistogram} histogram classes. Support for floating point value
 * iteration is provided with {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleHistogramIterationValue} and related iterator classes (
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleLinearIterator}, {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleLogarithmicIterator},
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoublePercentileIterator}, {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleRecordedValuesIterator},
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleAllValuesIterator}). Support for interval recording is provided with
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleRecorder} and
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.SingleWriterDoubleRecorder}.
 ...
 * com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleHistogram} (and variants) is not specified upfront. Only the dynamic range of values
 * that the histogram can cover is (optionally) specified. E.g. When a {@link com.solarwinds.joboe.core.metrics.hdrHistogram.DoubleHistogram}
 ...
 * {@link com.solarwinds.joboe.core.metrics.hdrHistogram.AbstractHistogram#getEstimatedFootprintInBytes() getEstimatedFootprintInBytes()} method.
 */
