...
import com.solarwinds.joboe.core.instrumentation.HeaderConstants;
...
import com.solarwinds.joboe.core.span.propagation.Extractor;
import com.solarwinds.joboe.core.span.propagation.Format;
import com.solarwinds.joboe.core.span.propagation.Injector;
import com.solarwinds.joboe.core.span.propagation.TextMap;
 ...
 *
 */
public class Tracer implements com.solarwinds.joboe.core.span.Tracer {
...
//    public static final Tracer NO_OP = new Tracer();
    ...
    @Override
    public <C> void inject(com.solarwinds.joboe.core.span.SpanContext spanContext, Format<C> format, C carrier) {
    ...
    @Override
    public <C> com.solarwinds.joboe.core.span.SpanContext extract(Format<C> format, C carrier) {
    ...
    public class SpanBuilder implements com.solarwinds.joboe.core.span.Tracer.SpanBuilder {
...
//            newSpan.setSpanPropertyValue(SpanProperty.ENTRY_XID, newSpan.context().getMetadata().toHexString()); //tag it as the metatdata will get updated/invalidated later on
        ...
        @Override
        public SpanBuilder asChildOf(com.solarwinds.joboe.core.span.SpanContext parentContext) {
            this.explicitParentContext = (SpanContext) parentContext; 
            return this;
        }

        @Override
        public SpanBuilder asChildOf(com.solarwinds.joboe.core.span.Span parentSpan) {
            return asChildOf(parentSpan.context());
        }

        @Override
        public SpanBuilder addReference(String referenceType, com.solarwinds.joboe.core.span.SpanContext referencedContext) {
            throw new UnsupportedOperationException();
        }
         ...
         * {@link com.solarwinds.joboe.core.span.Tracer.SpanBuilder#addReference(String, SpanContext)}
         * @return
         */
    ...
    @Override
    public Scope activateSpan(com.solarwinds.joboe.core.span.Span span) {
