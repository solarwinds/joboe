...
public class ScopeManager implements com.solarwinds.joboe.core.span.ScopeManager {
    ...
    @Override
    public Scope activate(com.solarwinds.joboe.core.span.Span span) {
    ...
    @Override
    public Scope activate(com.solarwinds.joboe.core.span.Span span, boolean finishOnClose) {
        return activate(span, finishOnClose, false);
    }

    public Scope activate(com.solarwinds.joboe.core.span.Span span, boolean finishOnClose, boolean asyncActivate) {
