...
public class TimeUtils {
  ...
  //    private static ReadWriteLock readWriteLock = new ReentrantReadWriteLock(); removed locks as
  // even if they are concurrency issue it will be at worse be off by the offset for a few
  // operations, not a big deal
