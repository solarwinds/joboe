...
//    public static boolean isMetricsEnabled(String resource) {
//        Boolean localUrlMetricsEnabled = getLocalUrlMetricsEnabled(resource);
//        return localUrlMetricsEnabled != null ? localUrlMetricsEnabled : true; //metrics enabled by default
//    }
...
//    private static Boolean getLocalUrlMetricsEnabled(String resource) {
//        if (resource != null && Agent.getUrlConfigs() != null) {
//            return Agent.getUrlConfigs().getMetricsEnabled(resource);
//        } else{
//            return null;
//        }
//    }
