...
public class ShortCountsHistogram extends AbstractHistogram {
  ...
  void setCountAtIndex(int index, long value) {
    setCountAtNormalizedIndex(
        normalizeIndex(index, normalizingIndexOffset, countsArrayLength), value);
  }
  ...
  @Override
  public ShortCountsHistogram copyCorrectedForCoordinatedOmission(
   ...
   */
  public static ShortCountsHistogram decodeFromByteBuffer(
   ...
   */
  public static ShortCountsHistogram decodeFromCompressedByteBuffer(
      final ByteBuffer buffer, final long minBarForHighestTrackableValue)
      throws DataFormatException {
    return decodeFromCompressedByteBuffer(
        buffer, ShortCountsHistogram.class, minBarForHighestTrackableValue);
  }
