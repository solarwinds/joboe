...
public class IntCountsHistogram extends AbstractHistogram {
  ...
  @Override
  public IntCountsHistogram copyCorrectedForCoordinatedOmission(
   ...
   */
  public static IntCountsHistogram decodeFromByteBuffer(
   ...
   */
  public static IntCountsHistogram decodeFromCompressedByteBuffer(
      final ByteBuffer buffer, final long minBarForHighestTrackableValue)
      throws DataFormatException {
    return decodeFromCompressedByteBuffer(
        buffer, IntCountsHistogram.class, minBarForHighestTrackableValue);
  }
