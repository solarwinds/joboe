...
import com.solarwinds.instrumentation.HeaderConstants;
...
import com.solarwinds.joboe.span.propagation.Extractor;
import com.solarwinds.joboe.span.propagation.Format;
import com.solarwinds.joboe.span.propagation.Injector;
import com.solarwinds.joboe.span.propagation.TextMap;
 ...
 *
 */
public class Tracer implements com.solarwinds.joboe.span.Tracer {
...
//            newSpan.setSpanPropertyValue(SpanProperty.ENTRY_XID, newSpan.context().getMetadata().toHexString()); //tag it as the metatdata will get updated/invalidated later on
         ...
         * {@link com.solarwinds.joboe.span.Tracer.SpanBuilder#addReference(String, SpanContext)}
         * @return
         */
    ...
    @Override
    public Scope activateSpan(com.solarwinds.joboe.span.Span span) {
