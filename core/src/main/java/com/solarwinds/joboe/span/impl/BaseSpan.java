...
public interface BaseSpan {
    ...
    public static class SpanProperty<V> {
        ...
        public static final SpanProperty<Boolean> IS_SDK = new SpanProperty<Boolean>(com.solarwinds.joboe.span.impl.Span.SpanProperty.IS_SDK);
        private final com.solarwinds.joboe.span.impl.Span.SpanProperty<V> wrapped;
