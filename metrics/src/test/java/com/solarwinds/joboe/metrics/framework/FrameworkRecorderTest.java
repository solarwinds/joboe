...
import com.solarwinds.joboe.metrics.framework.FrameworkRecorder.FrameworkInfo;
...
public class FrameworkRecorderTest {
  ...
  public void testExtractBundleFramework() {
    ...
    attributes.putValue(
        "Export-Package",
        "com.mongodb, com.mongodb.io, com.mongodb.util, com.mongodb.gridfs, org.bson, org.bson.util, org.bson.types, org.bson.io");
