package com.solarwinds.joboe.metrics.histogram;
...
public class MockHistogramAdapter implements Histogram {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
        prime * result + ((countHigherThanValue == null) ? 0 : countHigherThanValue.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (countHigherThanValue == null) {
      if (other.countHigherThanValue != null) return false;
    } else if (!countHigherThanValue.equals(other.countHigherThanValue)) return false;
    if (last == null) {
    ...
    if (percentile == null) {
      if (other.percentile != null) return false;
    } else if (!percentile.equals(other.percentile)) return false;
    if (standardDeviation == null) {
      if (other.standardDeviation != null) return false;
    } else if (!standardDeviation.equals(other.standardDeviation)) return false;
