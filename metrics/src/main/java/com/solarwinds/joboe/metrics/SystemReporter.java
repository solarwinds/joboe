...
/**
 * Reports data collected by {@link SystemCollector}. Take note that this is not bound to any
 * reporting method. Though the existing implementations all report {@link Event}, it does not have
...
public abstract class SystemReporter<T, D> {
   ...
   */
  public abstract void reportData(Map<T, D> collectedData, long interval)
