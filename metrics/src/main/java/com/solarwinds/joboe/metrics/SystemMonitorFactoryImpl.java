...
/**
 * Factory that creates the {@link SystemMonitor}. Currently it only supports building a full list
 * of {@code SystemMonitor}s based on the configurations in {@code ConfigContainer}
 *
 * @author Patson Luk
 */
public class SystemMonitorFactoryImpl implements SystemMonitorFactory {
  ...
  /**
   * Build a list of {@code SystemMonitor}s. To attach more {@code SystemMonitor} to the monitoring
   * system, add the construction in this method
   *
   * @return list of {@code SystemMonitor}s based on the configurations provided by the factory
   *     constructor
   */
  @Override
