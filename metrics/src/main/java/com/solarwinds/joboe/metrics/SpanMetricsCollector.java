...
public class SpanMetricsCollector extends AbstractMetricsEntryCollector {
  ...
  public SpanMetricsCollector(
      TransactionNameOverFlowSupplier transactionNameOverFlowSupplier,
      MetricSpanReporter... reporters) {
    this.transactionNameOverFlowSupplier =
        transactionNameOverFlowSupplier == null ? () -> false : transactionNameOverFlowSupplier;
